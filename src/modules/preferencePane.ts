 ...
 */
export function initPreferencePane(win: Window, onResetColors: () => void): void {
	...
	const contourColor = setupColorPicker(win, byID("contour-color"), "contourColor");
 ...
 */
function setPickerDisabled(picker: ColorPickerElement | null, disabled: boolean): void {
