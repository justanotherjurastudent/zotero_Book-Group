 ...
 */
export function parsePageStart(pages: string | null | undefined): number | null {
	if (!pages) {
		return null;
	}
 ...
 */
export function compareWithinGroup(a: GroupEntry, b: GroupEntry, compare: StringCompare): number {
	if (a.rank !== b.rank) {
